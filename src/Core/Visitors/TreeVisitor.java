...
public class TreeVisitor implements Visitor {
    ...
    public Object visitSequentialCommand(SequentialCommand ast, Object obj) {
        // si se pasa un param es unary
        if (ast.C2 ==null){
            return(createUnary("Sequential Command", ast.C1));
        }else{
    ...
    //Le estabamos pasando un atributo que nqv!
    public Object visitArrayTypeDenoter(ArrayTypeDenoter ast, Object obj) {
        return(createBinary("Array Type Denoter", ast.IL, ast.IL2));
    }
    ...
    public DefaultMutableTreeNode createBinary(String caption, AST child1, AST child2) {
        ...
        System.out.println("Lo hizo binary");
    ...
    public Object visitNothingCommand(NothingCommand nc, Object o) {
        return(createNullary("Nothing Command"));
    }

    
    public Object visitLoopWhileCommand(LoopWhileCommand lwc, Object o) {
        return(createBinary("LoopWhile Command", lwc.E, lwc.C));
    }

    
    public Object visitLoopUntilCommand(LoopUntilCommand luc, Object o) {
        return(createBinary("LoopUntil Command", luc.E, luc.C));
    }

    public Object visitLoopDoWhileCommand(LoopDoWhileCommand ldwc, Object o) {
        return(createBinary("LoopDoWhile Command", ldwc.E, ldwc.C));
    }

    public Object visitLoopDoUntilCommand(LoopDoUntilCommand lduc, Object o) {
        return(createBinary("LoopDoUntil Command", lduc.E, lduc.C));
    }

    public Object visitLoopForCommand(LoopForCommand lfc, Object o) {
        return(createQuaternary("LoopFor Command", lfc.I, lfc.E1, lfc.E2, lfc.C));
    }

    public Object visitRecDeclaration(RecDeclaration rd, Object o) {
        return(createUnary("Rec Declaration", rd.I));
    }
    ...
    public Object visitElsifCommand(ElsifCommand ec, Object o) {
        return(createTernary("Elsif Command", ec.E, ec.C1, ec.C2));
    }
